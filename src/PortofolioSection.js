  ...
  return (
    <section id="portofolio" className="pt-36 pb-32 bg-slate-100">
      ...
      <div className="rounded-md shadow-md overflow-hidden">
        <img src="img/websitesmartti.jpeg" alt="First Website" className="w-full" />
      </div>
      ...
      <p className="font-medium text-base text-secondary">SmartTi is a website specializing in website creation, game development, and domain hosting.</p>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <img src="img/juara1codingcompetition.jpeg" alt="Coding Competition Champion" className="w-full" />
            </div>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <img src="img/juara1lombasilat.jpeg" alt="Smamda Cup Champion" className="w-full" />
            </div>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <img src="img/juara2futsalsoccerfest.jpeg" alt="Futsal Soccer Fest Runner-Up" className="w-full" />
            </div>
